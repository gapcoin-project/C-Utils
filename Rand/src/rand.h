 ...
 *
 * This file is intended to be used in other projects.
 * 
 ...
 *
 * the basic Algorithm:
 * To respect Robin Whittle whish, this was the basic algorithm:
 *
 *
 *                                   * rand31pmc_next()
 *                                   *
 ...
 *                                   *
 *                                          
 *ng unsigned int rand31pmc_next()
 ...
 *
 * And here comes my inline uint32_t version
 */
#ifndef __RAND_H_
#define __RAND_H_
...
static inline uint32_t next_rand32_serial() {
  ...
  lo = 16807 * (rand32_seed & 0xFFFF);
  hi = 16807 * (rand32_seed >> 16);
